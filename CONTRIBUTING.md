# Contributing to sockjs-dart-client
...
[open an issue](https://github.com/Workiva/sockjs-dart-client/issues/new) and fill out
...
Please contact us on Slack or [create a JIRA ticket](https://jira.atl.workiva.net/secure/CreateIssue!default.jspa?pid=CPLAT&component=sockjs-dart-client)
and fill out the description with as much detail as necessary.

## Contributing Changes
If you're contributing a change to sockjs-dart-client, please follow this process: (and
thank you!)
